...
<body>
                    ...
                    <?php while ($data = $posts->fetch()) { ?>
                        <tr>
                            ...
                            <td class="t-status t-active">
                                <a href="http://localhost/CoursPHP/TPBlog/OCRP3/index.php?action=admin&adminAction=view&id=<?= $data['id']; ?>"><button class="btn btn-success btn-xs" data-title="View" data-toggle="modal" data-target="#view" ><i class="fa fa-eye" aria-hidden="true"></i></button></a>
                                ...
                                <button type="button" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#exampleModal"><i class="fa fa-trash-o" aria-hidden="true"></i></button>
                            </td>
                        </tr>
    ...
    <div class="container">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-8"><h2 id="Reported-comment">Commentaires signalés </h2></div>
                    <div class="col-sm-4">
                            ...
                            <?php foreach ($reportedComments as $comment): ?>
                                <tr>
                                    ...
                                    <td data-label="Actions" class="actionComment">
                                        ...
                                        <button class="btn btn-danger btn-xs" data-title="Delete" data-toggle="modal" data-target="#deleteModalComment" ><i class="fa fa-trash-o" aria-hidden="true"></i></button>
